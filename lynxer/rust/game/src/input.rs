...
export_int!(clynxer_game_key_down, args, {
    if headless() {
        return 0;
    }
...
export_int!(clynxer_game_key_up, args, {
    if headless() {
        return 0;
    }
    match key_code(args.string(0)) {
...
export_int!(clynxer_game_key_pressed, args, {
    if headless() {
        return 0;
    }
    match key_code(args.string(0)) {
...
export_int!(clynxer_game_key_released, args, {
    if headless() {
        return 0;
    }
    match key_code(args.string(0)) {
...
export_int!(clynxer_game_key_code, args, {
    match key_code(args.string(0)) {
...
export_float!(clynxer_game_mouse_x, args, {
    let _ = args;
    if headless() {
        return 0.0;
    }
...
export_float!(clynxer_game_mouse_y, args, {
    let _ = args;
    if headless() {
        return 0.0;
    }
...
export_float!(clynxer_game_mouse_delta_x, args, {
    let _ = args;
    if headless() {
        return 0.0;
    }
...
export_float!(clynxer_game_mouse_delta_y, args, {
    let _ = args;
    if headless() {
        return 0.0;
    }
...
export_int!(clynxer_game_mouse_left, args, {
    let _ = args;
    if headless() {
        return 0;
    }
...
export_int!(clynxer_game_mouse_right, args, {
    let _ = args;
    if headless() {
        return 0;
    }
...
export_int!(clynxer_game_mouse_middle, args, {
    let _ = args;
    if headless() {
        return 0;
    }
...
export_int!(clynxer_game_mouse_button_down, args, {
    if headless() {
        return 0;
    }
...
export_int!(clynxer_game_mouse_button_pressed, args, {
    if headless() {
        return 0;
    }
    match mouse_button(args.string(0)) {
...
export_int!(clynxer_game_mouse_button_released, args, {
    if headless() {
        return 0;
    }
    match mouse_button(args.string(0)) {
...
export_int!(clynxer_game_mouse_button_code, args, {
    match mouse_button(args.string(0)) {
...
export_float!(clynxer_game_mouse_scroll_y, args, {
    let _ = args;
    with(|state| {
...
export_float!(clynxer_game_mouse_scroll_x, args, {
    let _ = args;
    with(|state| {
