...
PyObject *pyNativeModuleLoad(PyObject *, PyObject *args) {
    ...
    if (!initializer) {
        dlclose(handle);
        PyErr_SetString(PyExc_RuntimeError,
            "native module lifecycle failure: missing clynxer_module_init_v1 entry point");
        return nullptr;
    }
...
PyObject *ffiCallbackCallableCallImpl(FfiCallbackCallable *self, PyObject *args,
    ...
    PyObject *runtime = PyImport_ImportModule("clynxer.clynxer");
...
PyMODINIT_FUNC PyInit_cpp() {
    FfiCallbackCallableType.tp_name = "clynxer.cpp.FfiCallbackCallable";
