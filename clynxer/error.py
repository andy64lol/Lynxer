...
except ImportError:  # clynxer package not importable as a package
    from clynxer.strings_with_arrows import string_with_arrows  # type: ignore[no-redef]
...
def _warning_message_paths() -> list[str]:
    ...
    if frozen_root:
        paths.append(os.path.join(frozen_root, "clynxer", "warnings.txt"))
...
class ClynxerForeverWarning(UserWarning):
